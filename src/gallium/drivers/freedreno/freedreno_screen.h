...
struct fd_screen {
   ...
   /* for gen8, these need to be sized for two draws.. for simplicity just
    * double the size for everyone.
    */
#define FD6_TESS_FACTOR_SIZE (16 * 1024)
#define FD6_TESS_PARAM_SIZE (256 * 1024)
